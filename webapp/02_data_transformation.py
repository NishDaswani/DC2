...
# Define file paths
OUTPUT_DIR = "data/01_final_data" # Relative to the workspace root
OUTPUT_CSV_NAME = "Burglary-Classified-Data.csv"
...
FINAL_OUTPUT_CSV_NAME = "final_processed_data_new.csv"
                    ...
                    try:
                        ...
                        if lsoa_col_name_in_excel and pop_col_name:
                            ...
                            sheet_data_mapped = pd.merge(
                                ...
                                how='left' # Use left to keep all rows from sheet_data_raw
                            )
